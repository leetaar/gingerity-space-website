...
SVC_NAME="actions.runner.leetaar-gingerity-space-website.gingerity.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (leetaar-gingerity-space-website.gingerity)"
